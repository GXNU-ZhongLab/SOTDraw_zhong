...
if __name__ == '__main__' :
    parser = argparse.ArgumentParser(description='create json for LaSOT test tuning')
    parser.add_argument('--dataset_path', type=str,default='/home/data/lasot',
    ...
    parser.add_argument('--name', type=str, default='lasot',help='LaSOT or LaSOText')
