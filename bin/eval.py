...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str,default='LaSOT', help='dataset name') #数据集的名称
    parser.add_argument('--tracker_result_dir', default='./result', type=str, help='tracker result root') #跟踪器的跟踪结果txt文件存放出，里面文件夹命名记得和tracker名字保持一致
    parser.add_argument('--trackers',default=['USCLTrack','EVPTrack','SeqTrack','ROMTrack', 'OSTrack',], nargs='+') #tracker的名字
    parser.add_argument('--vis', dest='vis', action='store_true',default=True)
    parser.add_argument('--show_video_level', dest='show_video_level', action='store_true', default=True)
    parser.add_argument('--num', type=int, help='number of processes to eval', default=4)
